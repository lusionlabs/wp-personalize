...
<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		var lastRowID				= 0;
		var lastScriptCode	= '';
		var locationArr			= <?php echo jsonesc_html_encode( $locationArr ); ?>;
		var typeArr					= <?php echo jsonesc_html_encode( $typeArr ); ?>;
		var areaArr					= <?php echo jsonesc_html_encode( $areaArr ); ?>;
